			<!-- start footer Area m 4229,4359-->		
			<footer class="footer-area"><!--m3996-->
				<div class="container"><!--b590-->

					<div class="row">
					
					<div class="row footer-bottom d-flex justify-content-between align-items-center">
						<p class="col-lg-8 col-sm-12 footer-text m-0">
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || Sistem Informasi Geografis </i> by Tsabitta N.R || L200200240</a> <!--b659-->
</p>
						<div class="col-lg-4 col-sm-12 footer-social">
							<a href="https://www.facebook.com/InfoPariwisataSolo/" target="_blank"><i class="fa fa-facebook"></i></a>
							<a href="https://www.instagram.com/pariwisatasolo/" target="_blank"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
				</div>
			</footer>
